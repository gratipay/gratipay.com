Gratipay.project = (function() {

    var $t = function(selector) { return selector ? $(selector, 'table.project') : $('table.project'); };
    ...
    function drawRows(available, members) {
        ...
        $t('.project-members').html(rows);
        $t('.project-members .edit').submit(doTake);
        $t('.project-members .edit input').focus().keyup(maybeCancelTake);
        $t('.project-members .remove').click(remove);
    }
