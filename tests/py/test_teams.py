...
class TestTeams(Harness):
    ...
    # Cached values - receiving, nsupporters etc.

    def test_receiving_only_includes_funded_subs(self):
    ...
    def test_receiving_only_includes_latest_subs(self):
        ...
        alice.set_subscription_to(team, '5.00')
...
>>>>>>> Failing tests for team#receiving
